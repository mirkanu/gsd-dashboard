...
Reference full template: `/data/home/gsddashboard/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/data/home/gsddashboard/.claude/get-shit-done/templates/state.md`.
